                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        @if($permission->image)
                                            ...
                                            <div>
                                                <img src="{{ asset('storage/permissions/'.$permission->image) }}" alt="Bukti Dukung"
                            ...
                            <div class="card-footer text-right">
                                <a href="{{ route('permissions.edit', $permission->id) }}" class="btn btn-primary">Edit Permission For Approve</a>
                            </div>
                        </div>
                    </div>
                </div>
